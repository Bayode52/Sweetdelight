        ...
        <div className="min-h-screen bg-[#FDF6F0]">
            ...
            <div className="bg-bakery-primary text-white py-24 px-4 text-center space-y-6">
                ...
                <p className="text-white/60 text-lg max-w-lg mx-auto">
                    Join Sweet Delites and get <strong className="text-white">10% off your first order</strong> with code{" "}
            ...
            <div className="max-w-4xl mx-auto px-4 py-16 space-y-10">
                <h2 className="text-3xl font-playfair font-black text-bakery-primary text-center">
                    Why <span className="text-bakery-cta italic">Sweet Delites?</span>
                </h2>
