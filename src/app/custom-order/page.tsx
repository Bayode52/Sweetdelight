                ...
                <div className="max-w-5xl mx-auto px-6">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-bakery-primary/70 max-w-2xl mx-auto leading-relaxed">
                            Tell us exactly what you're craving. Our Sweet Delites AI will visualise your dream product, provide an instant price estimate, and prepare it for our kitchen.
                        </p>
                    </div>
                        ...
                        {orderSuccess && (
                            <div className="text-center py-16 animate-in zoom-in duration-500 max-w-xl mx-auto">
                                ...
                                <p className="text-lg text-bakery-primary/70 mb-8">
                                    Thank you for choosing Sweet Delites. Our team is reviewing your custom order details. We will be in touch shortly to confirm everything and arrange payment.
                                </p>
